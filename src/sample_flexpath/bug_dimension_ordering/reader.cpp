...
int main(int argc, char **argv) {
    ...
    dim_start[0] = 0; dim_start[1] = 0;
    dim_count[0] = 2; dim_count[1] = 2;
    sel = adios_selection_boundingbox(2, dim_start, dim_count);
    ...
    adios_schedule_read(fp_in, sel, "data", 0, 1, data);
